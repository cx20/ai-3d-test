...
function createScene(engine) {
    ...
    // Nose
    var nose = BABYLON.MeshBuilder.CreateCylinder("nose", { height: 0.1, diameterTop: 0.05, diameterBottom: 0.2, tessellation: 16 }, scene);
    ...
    // Hat
    var hatBrim = BABYLON.MeshBuilder.CreateCylinder("hatBrim", { height: 0.2, diameterTop: 3.4, diameterBottom: 3.4, tessellation: 32 }, scene);
    hatBrim.position.y = 6.1;
    hatBrim.material = hatMaterial;

    var hatTop = BABYLON.MeshBuilder.CreateCylinder("hatTop", { height: 1.5, diameterTop: 0, diameterBottom: 2, tessellation: 32 }, scene);
